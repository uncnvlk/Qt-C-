...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CheckBoxDelegate_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CheckBoxDelegate_t qt_meta_stringdata_CheckBoxDelegate = {
    {
        QT_MOC_LITERAL(0, 16)   // "CheckBoxDelegate"
    },
    "CheckBoxDelegate"
};
...
Q_CONSTINIT static const uint qt_meta_data_CheckBoxDelegate[] = {
...
Q_CONSTINIT const QMetaObject CheckBoxDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_CheckBoxDelegate.offsetsAndSizes,
    qt_meta_data_CheckBoxDelegate,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CheckBoxDelegate_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CheckBoxDelegate, std::true_type>
    >,
    nullptr
} };
